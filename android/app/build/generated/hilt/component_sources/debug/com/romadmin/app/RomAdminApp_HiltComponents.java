...
import com.romadmin.app.di.AppModule;
import com.romadmin.app.di.DatabaseModule;
...
import com.romadmin.app.ui.setup.SetupViewModel_HiltModules;
import com.romadmin.app.worker.DownloadWorker_HiltModule;
import com.romadmin.app.worker.SaveSyncWorker_HiltModule;
import dagger.Binds;
...
public final class RomAdminApp_HiltComponents {
  private RomAdminApp_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          SaveSyncWorker_HiltModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements RomAdminApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          GameDetailViewModel_HiltModules.KeyModule.class,
